use crate::{error::Error::{InvalidIDError, MongoQueryError}, handler::BookRequest, Book, Result};
use chrono::prelude::*;
...
impl DB {
    pub async fn init() -> Result<Self> {
        ...
        let uri = format!("mongodb+srv://{}:{}@{}/{}?retryWrites=true&w=majority", &db_user, &db_password, &db_host, &db_name);
    ...
    fn get_collection(&self) -> Collection {
        self.client.database("poc").collection(COLL)
    }
